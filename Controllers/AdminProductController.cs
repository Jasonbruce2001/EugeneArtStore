...
namespace EugeneArtStore.Controllers
{
    public class AdminProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Name,Description,InStock")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Price,Name,Description,InStock")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
